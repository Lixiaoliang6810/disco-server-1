...
public class SmsServiceImpl implements SmsService {
    ...
    /**
     * 新订单短信提醒服务
     * @param receivePhone 店家手机
     * @param mobile 预定的客户手机
     * @param arrivalTime 预计到达时间
     * @param amount 预计人数
     */
    @Override
    public SendSmsResponse newOrderSmsNotify(String receivePhone,String mobile, String arrivalTime, String amount) throws ClientException {
        //设置超时时间-可自行调整
        ...
        request.putQueryParameter("PhoneNumbers", receivePhone);
        //必填:短信签名-可在短信控制台中找到
        ...
        request.setTemplateParam("{\"phone\":\"" + mobile + "\"}");
        request.setTemplateParam("{\"time\":\"" + arrivalTime + "\"}");

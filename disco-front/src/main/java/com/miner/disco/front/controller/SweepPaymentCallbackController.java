...
public class SweepPaymentCallbackController {
    ...
    @PostMapping(value = "/alipay/sweep/notify")
    public void sweepAlipayNotify(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (StringUtils.equals(trade_status, ALIPAY_TRADE_SUCCESS) && StringUtils.isNotBlank(params.get("buyer_pay_amount"))) {
                ...
                Long qrcodeId = Long.parseLong(customParams.get("qrcodeId"));
                Long vipId = Long.parseLong(customParams.get("vipId"));
                Long memberId = Long.parseLong(customParams.get("memberId"));
                ...
                sweepPaymentNotifyRequest.setQrcodeId(qrcodeId);
                sweepPaymentNotifyRequest.setVipId(vipId);
                sweepPaymentNotifyRequest.setMemberId(memberId);
    ...
    @PostMapping(value = "/wxpay/sweep/notify")

 ...
 */
public class NeteaseImGetUinfoModel extends NeteaseImObject implements Serializable {

    private static final long serialVersionUID = -8118363410838219845L;

    private String accids;  //	String	是	用户帐号，最大长度32字符，必须保证一个APP内唯一
    ...
    private Integer gender; //	int	    否	用户性别，0表示未知，1表示男，2女表示女，其它会报参数错误
